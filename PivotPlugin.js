...
var PivotPlugin = function (_Component) {
    _inherits(PivotPlugin, _Component);

    function PivotPlugin(props) {
        _classCallCheck(this, PivotPlugin);

        var _this = _possibleConstructorReturn(this, (PivotPlugin.__proto__ || Object.getPrototypeOf(PivotPlugin)).call(this, props));
