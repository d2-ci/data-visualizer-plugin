...
var ContextualMenu = function ContextualMenu(_ref) {
  ...
  }, React__default.createElement(uiCore.Menu, null, Boolean(ouData === null || ouData === void 0 ? void 0 : ouData.children.length) && React__default.createElement(React__default.Fragment, null, React__default.createElement(uiCore.MenuItem, {
    dense: true,
...
var VisualizationPlugin = function VisualizationPlugin(_ref4) {
  ...
  var _useState9 = React.useState(visualization),
  ...
  var onContextualMenuItemClick = function onContextualMenuItemClick(args) {
    ...
    if (!onDrill) {
      if (args.ou) {
        ...
        setVis(analytics.layoutReplaceDimension(visualization, analytics.DIMENSION_ID_ORGUNIT, ouItems)); // TODO
        // if (args.pe) {
      }
    } else {
      onDrill(args);
