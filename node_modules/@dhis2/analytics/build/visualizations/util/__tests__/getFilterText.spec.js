...
var _getFilterText = _interopRequireDefault(require("../getFilterText"));
...
describe('getFilterText', function () {
  ...
  describe('metadata is missing', function () {
    it('uses uids in the title', function () {
      filters.push({
  ...
  describe('relative period does not expand the items', function () {
    it('uses the name for the relative period id if available', function () {
      filters.push({
        dimension: 'pe',
        items: [{
          id: '_LAST_2_MONTHS_',
